                ...
                <div className="modal" id="modal" onClick={handleClose} >
                    <div className="contentModal">
                        ...
                        <div className='botoes'>
                            <button className='btnEnviar' onClick={handleClose}>Excluir</button>
                            <button className='btnEnviar' onClick={handleClose}>Cancelar</button>
                        </div>
                    </div>
                </div>
            )}
